...
def validate_env_vars(provider):
    ...
    - S3_DO: DigitalOcean Spaces (auto-detects bucket/region from endpoint)
    - R2: Cloudflare R2 (S3-compatible, uses region "auto")
    """
    required_vars = {
        ...
        'R2': ['S3_ENDPOINT_URL', 'S3_ACCESS_KEY', 'S3_SECRET_KEY', 'S3_BUCKET_NAME', 'S3_REGION']
    }
